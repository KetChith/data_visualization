                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "Kernel Density Estimation (KDE) to analyze the distribution of selected ETFs.",
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "Visualize cumulative returns as a bar chart.",
                                        style={'color': 'lightgray'},
                                    ),
                                    dcc.Loading(
...
def update_graphs(start_date, end_date, selected_etfs, price_type):
    ...
    if price_type in ['Daily Percent Change', 'Estimated Value Traded']:
        ...
        cumulative_fig.update_layout(
            title="Cumulative Returns of Selected ETFs (Bar Chart)",
            xaxis_title="Date",
